...
if __name__ == '__main__':
    ...
    spark.sql(""" select 
                    ...
                    'A' as dl_status
                     from( 
                        ...
                        ) a """.format(fix_time_same_batch, fix_time_same_batch, ff_loaded_dt_most)).filter(
        "A字段 is not null") \
    ...
    if count > 0:
        ...
        spark.sql(""" select dl_id,
                            ...
                            dl_start_dt,
                            dl_end_dt,
                            dl_status  from tmp_dl.m表名称_keep_tmp """) \
    ...
    spark.sql(""" drop table if exists tmp_dl.m表名称_updated_tmp""")
